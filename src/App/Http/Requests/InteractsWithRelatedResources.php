...
trait InteractsWithRelatedResources
{
     ...
     *
     * @return \InWeb\Admin\App\Resource
     */
    ...
    public function findParentModel()
    {
        return once(function () {
            ...
            return Admin::modelInstanceForKey($this->viaResource)
    ...
    {
        return once(function () {
            return Admin::modelInstanceForKey($this->relatedResource)
                ->newQueryWithoutScopes()
    ...
    public function pivotName()
    {
        ...
        $resource = Admin::resourceInstanceForKey($this->viaResource);
