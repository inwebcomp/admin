...
use InWeb\Admin\App\Console\Concerns\AcceptsNameAndVendor;
...
class ToolCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'admin:tool {name}';
    ...
    public function handle()
    {
        ...
        // api.stub replacements
        $this->replace('{{ component }}', $this->toolName(), $this->toolPath() . '/routes/api.stub');
        ...
        $this->replace('{{ name }}', $this->composerName(), $this->toolPath() . '/composer.json');
    ...
    {
        return base_path('admin-components/Tools/' . $this->toolClass());
    }
    ...
    {
        return 'admin-components/Tools/' . $this->toolClass();
    }
    ...
    {
        return Str::studly($this->toolVendor()) . '\\Tools\\' . $this->toolClass();
    }
    ...
    /**
     * Get the tool's composer name.
     *
     * @return string
     */
    private function composerName()
    {
        return str_replace('/', '/admin-', $this->argument('name'));
    }
}
