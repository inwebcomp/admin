<template>
    <div class="flex justify-center items-center px-6 py-8 bg-white not-data-found">
        <div class="text-center">
            <router-link v-if="this.resourceName && this.canCreate"
